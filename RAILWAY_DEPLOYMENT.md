...
**Notes:**
- Gateway token will be auto-generated and persisted if not provided
- Email configuration (ADMIN_EMAIL + SMTP) is optional but enables password reset functionality
...
3. Once deployed, your application will be ready to access
...
2. **Create Your Password**
   - On first visit, you'll see a "Create Your Password" wizard
...
3. **Complete Configuration**
   ...
   - Configure your AI provider (OpenRouter, OpenAI, Anthropic, etc.)
   - Add your API key
   - Optionally configure bot tokens for Telegram, Discord, or Slack
...
After initial setup, visiting `/setup` will prompt you to sign in with your password.

#### Forgot Password?

If you forget your password, you have two options:

**Option 1: Email Reset (if configured)**
1. Click "Forgot Password?" on the sign-in page
2. Check your email for a reset link (valid for 1 hour)
3. Click the link and create a new password

**Option 2: Manual Reset via Railway CLI**
```bash
...
To enable password reset via email, add these variables in Railway:
